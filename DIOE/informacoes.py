    ...
    for nome_arquivo in arquivos_txt_nomes: 
        ...
        try:
            ...
            for bloco_texto in blocos_completos:
                ...
                # Apply clean_text to all values before creating the dictionary
                novo_registro = {
                    "Tipo_Documento": clean_text(tipo_documento),
                    "Numero_Documento": clean_text(numero_documento),
                    "Situação": clean_text(situacao),
                    "Nome": clean_text(nome),
                    "RG": clean_text(rg),
                    "Titular_Ferias_Nome": clean_text(titular_ferias_nome),
                    "Periodo_Ferias": clean_text(periodo_ferias),
